...
<body class="bg-black">
    <div class="container bg-white pb-3 rounded" >
        <div class="border-bottom bg-black  rounded-bottom my-3 p-3 text-center border-2 bd-white">
            ...
            <h6 class="text-center bg-transparent bg-opacity-0 text-white m-2 p-1 col-2 m-auto"><a class="text-decoration-none text-white" target="_blank" href="https://www.linkedin.com/in/johnnyaracena/?locale=en_US"><img class="img-fluid col-1" src="include/img/Linkedin.ico" > johnnyaracena</a></h6>
